			...
			<div className="container py-4">
				<article>
					...
					<section>
						...
						<ul>
							<li>
								...
								for placing order(s) or delivery, we collect precise location data
								(GPS and network-based). If you permit the Build my body
								app/website to access location services through the permission
								system used by your mobile operating system ("platform"), we may
								also collect the precise location of your device when the app is
								running in the foreground or background to send retail store's
							...
							<li>
								...
								the permission system used by your mobile platform or website, we
								may access and store names and contact information from your
								address book on the device to facilitate social interactions
								through our Services. We may use the said information to check if
							...
							<li>
								...
								service requested, date and time the service was provided, amount
								charged, order(s) placed, and other related transaction details.
							...
							<li>
								...
								Services, preferences expressed, and settings chosen. In some
							...
							<li>
								...
								model, operating system and version, software and file names and
								versions, preferred language, unique device identifier,
								advertising identifiers, serial number, device motion information,
								and mobile network information to retrieve running apps and to
								improve performance. We may access information to find accounts on
							...
							<li>
								...
								with this service, we receive call data, including the date and
							...
							<li>
								...
								like device IP address, access dates and times, app features or
								...
								interacting with our Services. This information may be used to
								check network connection, receiving data from internet, prevent
					...
					<section>
						...
						<ul>
							<li>
								With Build my body subsidiaries and affiliated entities that
							...
							<li>
								...
								User agreements, Terms of Service, or policies, or to protect the
								rights, property, or safety of Build my body or others;
							</li>
							<li>
					...
					<section className="mt-3">
						...
						<p>
							...
							Access RightsBuild my body will comply with
							individual's requests regarding access, correction, and/or deletion
							of the personal data it stores in accordance with applicable law.
							Location Information We request permission for our app's collection
							of precise location from your device per the permission system used
							by your mobile operating system. Contact Information We may also
							seek permission for our app's collection and syncing of contact
							information from your device per the permission system used by your
							mobile operating system. Promotional Communications You may opt out
							of receiving promotional messages from us by following the
							instructions in those messages. If you opt out, we may still send
							you non-promotional communications, such as those about your
							account, about Services you have requested, or our ongoing business
							relations. If you initially permit the collection of any
							information, you can later disable it by changing the settings on
