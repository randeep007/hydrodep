	...
	return (
		<>
			...
			<div className="container py-4">
				<h1 className="py-4">Terms & Conditions</h1>
				<div className="">
					<p>
						<strong>Introduction:</strong> In using/accessing the website, you
						are deemed to have accepted the terms and conditions of the
						agreement listed below or as may be revised from time to time ('User
						Agreement'), which is, for an indefinite period and you understand
						and agree that you are bound by such terms till the time you access
						this Website. If you have any queries about the terms and conditions
						of this User Agreement or have any comments or complaints on or
						about the Website, please email us at care@buildmybody.in or call us
						on +91 7177227777 . We reserve the right to change the terms and
						conditions of this User Agreement from time to time without any
					...
					<p>
						...
						without the explicit permission of Build my body. All information
						displayed, transmitted or carried on the Website is protected by
						copyright and other intellectual property laws. Copyrights and other
						intellectual property in respect of the some of the content on the
						Website may be owned by the third parties. This site is designed,
						updated and maintained by Build my body or its licensors. You shall
					...
					<p>
						...
						and information. In the preparation of the content of this Website,
						in particular to ensure that prices quoted are correct at time of
						publishing and all products have been fairly described. All prices
						are displayed inclusive of VAT. Services however are listed
						exclusive of service tax as rules for service tax vary with
						different services. Packaging may vary from that shown. The weights,
						dimensions and capacities given are approximate only. We have made
						every effort to display as accurately as possible the colours of our
						products that appear on the Website. However, as the actual colours
						you see will depend on your monitor, we cannot guarantee that your
						monitor's display of any colour will accurately reflect the colour
						of the product on delivery. All products/services and information
						displayed on the Website constitute an invitation to offer. Your
						order for purchase constitutes your offer which shall be subject to
						the terms and conditions of this User Agreement. We reserve the
						right to accept or reject your offer in part or in full. Our
						acceptance of your order will take place upon dispatch of the
						product(s) ordered. Dispatch of all the product(s) ordered, may or
						may not happen at the same time, in such a scenario that portion of
						the order which has been dispatched will be deemed to have been
						accepted by us and the balance would continue to be on offer to us
						and we reserve the right to accept or reject such balance order. No
						act or omission of Build my body prior to the actual dispatch of the
						product (s) ordered will constitute acceptance of your offer. If you
					...
					<ul>
						<li>
							...
							Mobile App or through any other mode of communication/ by making
						...
						<li>
							...
							my body and Google only, any violation to the policy will lead to
						...
						<li>
							...
							However, Build my body does not guarantee that the price will be
							the lowest in the city, region or geography. Prices and
						...
						<li>
							...
							modify, extend, update or withdraw the offers on products without
						...
						<li>
							...
							all relevant information and without obtaining the user's explicit
						...
						<li>
							...
							required to enter an agreement to list and sell only genuine
							products. And sellers determine the prices of the products they
							sell. We guarantee the condition of the item you buy when you
						...
						<li>
							...
							for any other reasons whatsoever, cancel the orders placed by
							Users. Build my body's decision of cancellation of order shall be
						...
						<li>
							...
							product or service information, Build my body may, at its
						...
						<li>
							...
							reserves the right, at its sole discretion, to refuse or cancel
							any order for any reason whatsoever, without assigning any reason
							to the User, User accept and undertake that the same is acceptable
							and he/ she/ it will not contest/ raise any dispute on the same.
							The situations that may result in cancellation of User's order
							includes, without limitation, no availability of the product or
							quantities ordered by User, non- availability of the service,
							inaccuracies or errors in pricing information, or problems
						...
						<li>
							...
							the User if all or any portion of User's order is cancelled or if
							additional information is required to accept the User's order. If
						...
						<li>
							...
							reason whatsoever, without assigning any reason to the User. As
							part of usual business practice, if Build my body receives a
						...
						<li>
							...
							not. User hereby agree and undertakes that the decision taken by
							the Build my body is acceptable to User and User shall not create
						...
						<li>
							...
							certain criteria. Build my body Reward Point or Promo Code used
							for placing the 'Bulk Order' will not be refunded as per this
					...
					<p>
						...
						person, per household or per order. These restrictions may be
						applicable to orders placed by the same account, the same credit /
						debit card, and also to orders that use the same billing and/or
						shipping address. We will provide notification to the customer
					...
					<p>
						...
						errors may occur. We cannot confirm the price of a product until
						after you order. In the event that a product is listed at an
						incorrect price or with incorrect information due to an error in
						...
						item is mis-priced, we may, at our sole discretion, either contact
						you for instructions or cancel your order and notify you of such
						cancellation. Unless the product ordered by you has been dispatched,
						your offer will not be deemed accepted and we will have the right to
						modify the price of the product and contact you for further
						instructions using the e-mail address or the contact number provided
						by you during the time of registration, or cancel the order and
						notify you of such cancellation. In the event we accept your order
						the same shall be debited to your credit / debit card account and
						duly notified to you by email or the contact number, as the case may
						be, that the payment has been processed. The payment may be
						processed prior to dispatch of the product that you have ordered. If
						we have to cancel the order after we have processed the payment, the
						said amount will be reversed back to your credit / debit card
						account. We strive to provide you with best value, however prices
						and availability are subject to change without notice. Our
						promotional offers/discounts are not site wide and are limited to
					...
					<p>
						...
						limitation implied, warranties or conditions of information and
						context). We shall not be liable to any person for any loss or
						damage which may arise from the use of any of the information
						contained in any of the materials on this Website. This User
						Agreement and any contractual obligation between us and you will be
						governed by the laws of India, subject to the exclusive jurisdiction
						of Courts in New Delhi. All disputes will be subject to arbitration
						in New Delhi in English by a single arbitrator appointed by us under
						the Arbitration and Conciliation Act, 1996. Each party to
						arbitration shall bear its own cost. You agree to defend, indemnify
						and hold harmless Build my body, its employees, directors, officers,
						...
						Build my body or any third party including but not limited to breach
						of any warranties, representations or undertakings or in relation to
						the non-fulfillment of any of your obligations under this User
						Agreement or arising out of your violation of any applicable laws,
					...
					<p>
						...
						applicable law. Persons who are "incompetent to contract" within the
						meaning of the Indian Contract Act, 1872 including un-discharged
						insolvents etc. are not eligible to use the Website. We reserve the
						right to terminate your membership and refuse to provide you with
						access to the Website at our sole discretion. The Website is not
						available to persons whose membership has been suspended or
						terminated by us for any reason whatsoever. If you are registering
						as a business entity, you represent that you have the authority to
						bind the entity to this User Agreement. We make no representation
						that any products or services referred to in the materials on this
						Website are appropriate for use, or available outside India. Those
						who choose to access this Website from outside India are responsible
						for compliance with local laws if and to the extent local laws are
						applicable. We will deliver the products only within India and will
						not be liable for any claims relating to any products ordered from
						outside India. Some Indian states prohibit direct sale of
						merchandise from other states and require special documentation to
						effect such a sale without dual taxation, if we receives an order
						from such states or to be delivered to such states under such
						circumstances we retain the right to accept or reject the order at
						our sole discretion. Those who choose to access this Website from
						Indian states which restrict such use are responsible for compliance
						with local laws if and to the extent local state laws are
					...
					<p>
						...
						retroactive. You can access, modify, correct and eliminate the data
						about you which has been collected pursuant to your decision to
						become a user of the Website. If you update any information relating
						to you, we may keep a copy of the information which you originally
						provided to us in its archives. Due to the communications standards
						on the Internet, when you visit the Website, we automatically
						receive the URL of the site from which you came and the site to
						which you are going when you leave. We also receive the Internet
						Protocol (IP) address of your computer (or the proxy server you used
						to access the World Wide Web), your computer operating system and
						type of web browser you are using, email patterns, as well as the
						name of your internet service provider (ISP). This information is
						used to analyze overall trends to help us improve our service. The
						Website uses temporary cookies to store certain data (that is not
						...
						your browser. We do not store personally identifiable information in
						the cookies. We may keep records of telephone calls received and
						made for making inquiries, orders or other purposes for the purpose
						of administration of services, research and development, quality
						management services and for proper administration. We allow other
						companies, to serve advertisements to you. These companies include
						third party ad servers, ad agencies, ad technology vendors and
						research firms. We may "target" some ads to you that fit a certain
						general profile. We do NOT use personally identifiable information
						to target ads. We assume no responsibility, and shall not be liable
						for, any damages to, or viruses that may infect your equipment on
						account of you access to, use of, or browsing the Website or the
						downloading of any material, data, text, images, video content, or
						audio content from the Website. If you are dissatisfied with the
						Website, your sole remedy is to discontinue using the Website. This
						privacy policy applies to websites and services that are operated
						and managed by us. We do not exercise control over the sites
						...
						computer, collect data or solicit personal information from you, for
						which we are not responsible or liable. Accordingly, we do not make
						...
						exclusion does not imply any endorsement by us of the website, the
						website's provider, or the information on the website. We encourage
						you to read the privacy policies of that website. The Website may
						enable you to communicate with other users or to post information to
						be accessed by others, whereupon other users may collect such data.
						We hereby expressly disclaim any liability for any misuse of such
						information that is made available by visitors in such a manner. We
						value the privacy of information pertaining to our associates. The
						...
						will respond to them appropriately. We do not disclose any personal
					...
					<p>
						...
						discretion, to suspend or cancel the service at any time if a
					...
					<p>
						...
						products, sales promotions, our newsletters, SMS updates, anything
						relating to other companies in our group or our business partners.
						If you would prefer not to receive any of this additional
						information as detailed in this paragraph (or any part of it) please
						click the "unsubscribe" link in any email that we send to you or
						register as a Do Not Disturb user. Within 7 working days (days which
						are neither (i) a Saturday nor Sunday, nor (ii) a public holiday
					...
					<p>
						...
						details provided by you for availing of services on the Website will
						be correct and accurate and you shall not use the credit /debit card
						or financial facility which is not lawfully owned / obtained by you.
						You also understand that any financial information submitted by you
						is directly received by our acquiring bank and not taken by us. We
						will not be liable for any credit / debit card fraud. The liability
						for use of a card fraudulently will be on you and the onus to 'prove
						otherwise' shall be exclusively on you. We and our associated
						acquiring bank or financial institutions reserve the right to
						recover the cost of goods, collection charges and lawyers fees from
						...
						of the Website and any other unlawful acts or acts or omissions in
					...
					<p>
						...
						legal requirement that such communications be in writing. When you
						submit your phone number along with your shipping address or to
						request our call back, you consent to receive calls on that number
					...
					<p>
						...
						other submissions disclosed, submitted to us on or by this Website
						or otherwise disclosed, submitted or offered in connection with your
						...
						intellectual properties in the Comments. Thus, we own exclusively
						all such rights, titles and interests and shall not be limited in
						any way in its use, commercial or otherwise, of any Comments. We
						...
						without compensating you in any way. We are and shall be under no
						obligation (1) to maintain any Comments in confidence; (2) to pay
						you any compensation for any Comments; or (3) to respond to any
						...
						proprietary right(s), and will not cause injury to any person or
						entity. You further agree that no Comments submitted by you to the
						Website will be or contain libelous or otherwise unlawful,
						threatening, abusive or obscene material, or contain software
						viruses, political campaigning, commercial solicitation, chain
						letters, mass mailings or any form of 'spam'. We do not regularly
						review posted Comments, but do reserve the right (but not the
						obligation) to monitor and edit or remove any Comments submitted on
						the Website. You grant us the right to use the name that you submit
						...
						agree to indemnify us and our affiliates for all claims resulting
					...
					<p>
						...
						materials, which appear on this Website. Access to this Website does
						not confer and shall not be considered as conferring upon anyone any
						license under any of our or any third party's intellectual property
						rights. All rights, including copyright, in this Website are owned
						by or licensed to us . Any use of this Website or its contents,
						...
						prior permission. You may not modify, distribute or re-post anything
						on this Website for any purpose. The Build my body names and logos
						and all related product and service names, design marks and slogans
						are the trademarks or service marks of Build my body or licensed to
						Build my body. All other marks are the property of their respective
						companies and you shall not use or exploit the same in any manner
						whatsoever. No trademark or service mark license is granted to you
						in connection with the materials contained on this Website. Access
						to this Website does not authorize anyone to use any name, logo or
						mark which appear on the Website in any manner. References on this
						Website to any names, marks, products or services of third parties
						...
						constitute or imply our endorsement, sponsorship or recommendation
						of the third party, information, product or service. We are not
						responsible for the content of any third party websites and does not
						make any representations regarding the content or accuracy of
						material on such websites. If you decide to link to any such third
						party websites, you do so entirely at your own risk. All materials,
						including images, text, illustrations, designs, icons, photographs,
						...
						ï¿½Contentsï¿½) are intended solely for personal, non-commercial
						use. You may download or copy the Contents and other downloadable
						materials displayed on the Website for your personal use only. No
						...
						part, any of the Content, the Website or any related software. All
						software used on this Website is the property of Build my body or
						its suppliers and licensors and protected by Indian and
						international copyright laws. The Content and software on this
						Website may be used only as a shopping resource. Any other use,
						including the reproduction, modification, distribution,
						transmission, republication, display, or performance, of the Content
						on this Website is strictly prohibited. Unless otherwise noted, all
						Content are copyrights, trademarks, trade dress and/or other
						intellectual property owned, controlled or licensed by us, our
						affiliates or by third parties who have licensed their materials to
						us and are protected by Indian and international copyright laws. The
						compilation (meaning the collection, arrangement, and assembly) of
						all Content on this Website is the exclusive property of Build my
						body and is also protected by Indian and international copyright
						laws. We don't offer any Counterfeit goods contain a trademark or
					...
					<p>
						...
						encounter Content that may be deemed by some to be offensive,
						indecent, or objectionable, which Content may or may not be
						identified as such. You agree to use the Website and any service at
					...
					<p>
						...
						this User Agreement at any time by informing us in writing through
						Indian postal system by registered post, that you no longer wish to
						be associated with this Website, provided that you discontinue any
						further use of this Website. We may terminate this User Agreement at
						any time and may do so immediately without notice, and accordingly
						deny you access to the Website. Such termination will be without any
						liability to Build my body. Upon any termination of the User
						Agreement by either you or us, you must promptly destroy all
						materials downloaded or otherwise obtained from this Website, as
					...
					<p>
						...
						of the Website. The Website provides content from other Internet
						websites or resources and while we try to ensure that material
						included on the Website is correct, reputable and of high quality,
						we shall not be held liable or responsible if this is not the case.
						We will not be responsible for any errors or omissions or for the
						results obtained from the use of such information or for any
						technical problems you may experience with the Website. This
						disclaimer does not apply to any product warranty offered by the
						manufacturer of the product as specified in the product
						specifications. This disclaimer constitutes an essential part of
						this User Agreement. To the fullest extent permitted under
						...
						prejudice to the generality of the section above, our total
						liability to you for all liabilities arising out of this User
						Agreement be it in tort or contract is limited to the amount charged
						to you, against the value of the products ordered by you. Build my
						body, its associates and technology partners make no representations
						or warranties about the accuracy, reliability, completeness and/or
						...
						and/or uninterrupted. We assumes no liability whatsoever for any
						...
						and/or any interruption or errors in the operation of the Website.
						The Images contained in this website is for general information
						...
						with respect to the images or the information, products, services,
						...
						images available on the website. Through this website you are able
						to get/ find the images available through various open source
						websites, which are not under the control of Build my body Connect.
						We have no control over the nature, content and availability of
						those open source sites. The inclusion of any images/ graphics does
						not necessarily imply a recommendation or endorse the views
						expressed within them.
						<em>
							Every effort is made to keep the website up and running smoothly.
							However, Build my body Connect takes no responsibility for, and
					...
					<ul>
						...
						<li>
							...
							this Website or any activity being conducted on this Website. You
							agree, further, not to use or attempt to use any engine, software,
							...
							engine and search agents available from Build my body on this
							Website and other than generally available third party web
						...
						<li>
							...
							server through firewalls. The Company does not access, store or
							keep debit card data or credit card data and or any financial
							...
							Build my body plays no role in the transaction, except for
							directing the customers to gateways or relevant webpage(s).
							Accordingly, Build my body shall not be responsible or liable for
							any loss or damage due to any disclosure whatsoever of Personal
							Information while using the third party gateways and or website.
							Build my body shall not be liable for any loss or damage sustained
							by reason of any disclosure (inadvertent or otherwise) of any
							Personal Information concerning the User's account and / or
							information relating to or regarding online transactions using
							credit cards / debit cards /cash cards/net banking and / or their
							verification process and particulars nor for any error, omission
							or inaccuracy with respect to any information so disclosed and
							used. We maintain physical, electronic and procedural safeguards
					...
					<p>
						...
						invalid or unenforceable provision will be deemed to be superseded
						by a valid, enforceable provision that most closely matches the
						intent of the original provision and the remainder of the User
						Agreement shall continue in effect. Unless otherwise specified
						herein, this User Agreement constitutes the entire agreement between
						you and us with respect to the Websites/services and it supersedes
						...
						Websites/services. Our failure to act with respect to a breach by
					...
					<p>
						...
						Product/Services, please contact our Grievance Officer , who will
						redress the grievances of the Users expeditiously but within one
					...
					<p>
						...
						the advice provided by your doctor or other health care
						professional. You should not use the information available on or
						through the Web Site (including, but not limited to, information
						that may be provided on the Web Site by healthcare or nutrition
						professionals employed by or contracting with Build my body) for
						diagnosing or treating a health problem or disease, or prescribing
						any medication. Information and statements regarding dietary
						supplements have not been evaluated by the Food and Drug
						Administration and are not intended to diagnose, treat, cure, or
						prevent any disease. You should read carefully all product packaging
						prior to use. The results from the products will vary from person to
